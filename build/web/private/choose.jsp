            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="jumbotron well" style="margin-top: 50px; background-image: url(<%= request.getContextPath()%>/img/sfondo2.jpg)">
                        <div id="jumbosearch">
                            <h2>
                                <fmt:message key="add.photo.restaurant"/>
                            </h2>
                            ...
                            <c:if test="${not empty message}"><br><font class="errMessage"><c:out value="${message}"/></font></c:if>
                                ...
                                <font class="descrMessage"><fmt:message key="photo.description"/></font> 
                                <input type="text" name="descr" placeholder="Breve descrizione..." size="50"/><br>
                                <font class="descrMessage"><fmt:message key="choose.image"/></font>
