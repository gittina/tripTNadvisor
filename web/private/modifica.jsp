                        ...
                        <div class="intro-text">
                            ...
                            <div class="col-md-4">
                                ...
                                <form enctype='multipart/form-data' method="POST" action="<%= request.getContextPath()%>/private/ModificaProfiloServlet">
                                    ...
                                    <input name="cognome" type="text" placeholder="Nuovo cognome" class="form-control"> 
                                    <br>
                                    <label class="control-label"><fmt:message key="insert.new.mail"/></label>
                                    <input name="mail" type="text" placeholder="Nuova mail" class="form-control"> 
                                    <br>      
                                    <label class="control-label"><fmt:message key="insert.old.password"/> </label>
                                    <input name="passOld" type="text" placeholder="Vecchia password" class="form-control">
                                    <br>
                                    <label class="control-label"><fmt:message key="insert.new.password"/></label>
                                    <input name="pass1" type="text" placeholder="Nuova password" class="form-control">
                                    <br>
                                    <label class="control-label"><fmt:message key="repeat.new.password"/></label>
                                    <input name="pass2" type="text" placeholder="Ripeti nuova password" class="form-control"> <br>
                                    <br>
