                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="divider"></li>
                                <li><a href="#"><img src="assets/img/flags/ES.png"/> Espanol <span class="label label-default">soon</span></a></li>
                                <li><a href="#"><img src="assets/img/flags/BR.png"/> Portugues <span class="label label-default">soon</span></a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
