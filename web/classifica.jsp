                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="intro-text">
                            <span class="name">Classifica Utenti per Ranking</span>
                            <hr class="star-light">
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <c:forEach var="utente" items="${classifica}">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <label class="control-label">Position: <c:out value="${utente.getPosizioneClassifica()}"/></label>
                            <br>
                            <label class="control-label"><c:out value="${utente.getNome()}"/></label>
                            <br>
                            <label class="control-label"><c:out value="${utente.getCognome()}"/></label>
                            <br>
                            <label class="control-label">Rank: <c:out value="${utente.getReputazione()}"/></label>
                        </div>
                        <div class="col-md-4">
